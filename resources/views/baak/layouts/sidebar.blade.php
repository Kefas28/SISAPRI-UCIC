    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::is('baak/*') ? 'active' : '' }}"
                    data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Prasarana</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/baak/kampus" class="dropdown-item">Kampus</a>
                    <a href="/baak/gedung" class="dropdown-item">Gedung</a>
                    <a href="/baak/ruang" class="dropdown-item">Ruang</a>
                </div>
            </div>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::is('baak/*') ? 'active' : '' }}"
                    data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Sarana</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/baak/kampus" class="dropdown-item">Kampus</a>
                    <a href="/baak/gedung" class="dropdown-item">Gedung</a>
                    <a href="/baak/ruang" class="dropdown-item">Ruang</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/baak/konten/sarana" class="dropdown-item">Konten Sarana</a>
                </div>
            </div>
            <div class="nav-item dropdown">
                <a href="#"
                    class="nav-link dropdown-toggle {{ Request::is('baak/peminjaman/*') ? 'active' : '' }}"
                    data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Peminjaman</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/baak/peminjaman/ruangan" class="dropdown-item">Peminjaman Ruang</a>
                </div>
            </div>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::is('baak/*') ? 'active' : '' }}"
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/baak/aduan" class="dropdown-item">Aduan</a>
                    <a href="/baak/kepuasan" class="dropdown-item">Kepuasan</a>
                </div>
            </div>
        </div>
    </nav>
