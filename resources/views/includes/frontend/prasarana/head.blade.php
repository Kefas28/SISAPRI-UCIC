<head>
    ...
    <link href="{{ url('assets/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/styles/news_post_styles.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('assets/styles/news_post_responsive.css') }}">
</head>
